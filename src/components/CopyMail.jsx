...
const CopyButton = () => {
  ...
  const copyMail = () => {
    console.log("copied");
    const mail = "sumitmangrait32@gmail.com";
  ...
  return (
    <div
      ...
      ref={wrapperRef}
      onClick={() => {navigator.clipboard.writeText("sumitmangrati32@gmail.com")}}
    > 
        {/* <img className="button-arrow h-[44px] " src={arrow} alt="" /> */}
        {/* <HiArrowNarrowDown className=" scale-[3]"/> */}
        <p className=" button-text font-rubik uppercase font-semibold z-[2]">start</p>
    </div>
  );
};
